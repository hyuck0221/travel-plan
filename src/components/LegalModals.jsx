...
export const PrivacyPolicy = ({isOpen, onClose}) => (
    <Modal title="개인정보처리방침" isOpen={isOpen} onClose={onClose}>
        ...
        <div className="legal-section">
            ...
            <p>Travelink AI 기능은 WebGPU를 이용해 기본적으로 Qwen 2.5 3B 로컬 모델을 사용자의 브라우저에서 실행하며, 기기의 WebGPU 메모리가 부족한 경우 Qwen 3 1.7B 초경량 모델로 전환할 수 있습니다. 사용자가 입력한 AI 프롬프트, 현재 일정, AI 대화 이력은 일정 작업을 해석하고 반영하기 위해 브라우저 내에서 처리되며, 생성형 AI 모델의 입력·출력 내용이 Travelink 서버나 별도의 외부 생성형 AI 서비스로 전송되거나 저장되지 않습니다.
                <br></br>
